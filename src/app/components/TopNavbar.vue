<template>
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" style="font-weight:600;" href="http://www.stario.net"> <img width="32px" src="http://7lrzqf.com1.z0.glb.clouddn.com/images/ucenter-logo.png" alt="WeStar" /> WeMesh &trade;</a>
