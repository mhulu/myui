...
<template>
  <div class="cov-vue-date">
    <div class="datepickbox">
      ...
      readonly="readonly"
      placeholder="{{v-bind:placeholder="option.placeholder"}}"
      v-model="time"
      :required="required"
      @click="showCheck"
      @foucus="showCheck"
      ...
      :style="{
        ...
        <div class="cov-date-box list-box" v-if="showInfo.year">
          <div class="cov-picker-box date-list" id="yearList">
            <div class="date-item" v-for="(yearItem, index) in library.year" track-by="index" @click="setYear(yearItem)">{{yearItem}}</div>
          </div>
        </div>
        <div class="cov-date-box list-box" v-if="showInfo.month">
          <div class="cov-picker-box date-list">
            <div class="date-item" v-for="(monthItem, index) in library.month" track-by="index" @click="setMonth(monthItem)">{{monthItem}}</div>
          </div>
        </div>
