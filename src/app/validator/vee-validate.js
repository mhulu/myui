...
var mobile$1 = (function (value) {
  return (/^1[3|4|5|7|8]\d{9}$/.test(value)
  );
});

var hanz$1 = (function (value) {
...
var messages = {
    ...
    mobile: function mobile(field) {
      return '手机号码格式不对'
    },
    hanz: function hanz(field) {
      return field + '必须为中文字符'
    },
    ...
    createClass(Validator, [{
        ...
        value: function _formatErrorMessage(field, rule) {
            if (!dictionary.hasLocale(this.locale) || typeof dictionary.getMessage(this.locale, rule.name) !== 'function') {
                ...
                return dictionary.getMessage('zh_cn', rule.name)(field, rule.params);
            }
        ...
        value: function setDefaultLocale() {
            var language = arguments.length <= 0 || arguments[0] === undefined ? 'zh_cn' : arguments[0];
        ...
        value: function _merge(name, validator) {
            if (typeof validator === 'function') {
                ...
                dictionary.setMessage('zh_cn', name, function (field) {
            ...
            if (validator.getMessage && typeof validator.getMessage === 'function') {
                dictionary.setMessage('zh_cn', name, validator.getMessage);
            }
...
var install = function install(Vue) {
    ...
    var locale = _ref$locale === undefined ? 'zh_cn' : _ref$locale;
